...
<template>
    <div>
        ...
        class="duration-300 transition-all relative">
            ...
            :class="`fixed h-full w-[60%] lg:w-[85%] top-0 right-0 bg-black/40 z-20 ${showSidebar ? 'visible opacity-100 lg:invisible lg:opacity-0' : 'invisible opacity-0'} duration-300`" />
